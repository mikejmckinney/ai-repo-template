...
3. [`.context/rules/README.md`](../.context/rules/README.md) — select the read profile for your task.
4. [`docs/guides/subagent-bootstrap-reference.md`](../docs/guides/subagent-bootstrap-reference.md) when dispatched as a subagent.
