...
For unexpected issues that are difficult to resolve like a process that consistently hangs, research the issue on the internet to see if it is a known issue others have encountered and what the fix or workaround is.