...
- Otherwise:
  ...
  - During **Mode B** onboarding, also reset `.context/00_INDEX.md`, `.context/roadmap.md`, `.context/vision/README.md`, and root `DESIGN.md` from the **canonical stub** blocks embedded in `.github/prompts/repo-onboarding.md`, even if the live template repo versions of those files no longer contain `TEMPLATE_PLACEHOLDER`.
