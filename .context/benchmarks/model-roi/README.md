...
- **Follow-on work:** the monolithic lifecycle is implemented on `main`; the Class C framework benchmark remains available through `06-implement-class-c-framework-benchmark.md` on `benchmark/roi`.
