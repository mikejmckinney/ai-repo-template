...
| `pack:core-min` | yes | yes | 2 | ~28k | **Smallest targeted floor:** [`.context/00_INDEX.md`](../../../00_INDEX.md) (context map) and [`.context/sessions/latest_summary.md`](../../../sessions/latest_summary.md) (recent session lessons). Manifest: [`context-packs/core-min.tsv`](../context-packs/core-min.tsv). |
