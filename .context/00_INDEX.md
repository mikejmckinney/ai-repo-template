...
4. Read your role file's `owned_paths` frontmatter and [docs/guides/multi-agent-coordination.md](../docs/guides/multi-agent-coordination.md) before touching files.
