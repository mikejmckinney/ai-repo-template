...
#
# Inlined from scripts/test-multi-dispatch-safety.sh by issue #280 (un-wrap legacy delegate).
...
@test "multi-dispatch-safety: inlined test-multi-dispatch-safety.sh body passes" {
  run _legacy_body
