...
#
# Inlined from scripts/test-auto-rebase-overlapping.sh by issue #280 (un-wrap legacy delegate).
...
@test "auto-rebase-overlapping: inlined test-auto-rebase-overlapping.sh body passes" {
  run _legacy_body
