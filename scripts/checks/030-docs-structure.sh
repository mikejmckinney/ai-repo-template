...
DOCS_FILES=(
  ...
  "docs/decisions/adr-030-non-blocking-review-pipeline.md"
  "docs/decisions/adr-031-agent-model-roi-benchmark-policy.md"
  "docs/decisions/adr-032-monolithic-agent-and-review-lifecycle.md"
