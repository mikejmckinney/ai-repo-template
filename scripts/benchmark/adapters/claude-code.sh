...
adapter_run() {
  ...
  case "${effort}" in
    minimal)
      kw=""
      effort_arg="low"
      applied="flag:--effort=low(minimal fallback)"
      ;;
    low)
      kw="think"
      effort_arg="low"
      applied="flag:--effort=low"
      ;;
    medium)
      kw="think hard"
      effort_arg="medium"
      applied="flag:--effort=medium"
      ;;
    high)
      kw="ultrathink"
      effort_arg="high"
      applied="flag:--effort=high"
      ;;
    xhigh)
      kw="ultrathink"
      effort_arg="xhigh"
      applied="flag:--effort=xhigh"
      ;;
    default | fixed | "")
      kw=""
      effort_arg=""
      applied="default(no-keyword)"
      ;;
    *)
      kw="think hard"
      effort_arg="medium"
      applied="flag:--effort=medium(fallback)"
      ;;
  esac
