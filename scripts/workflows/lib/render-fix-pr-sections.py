    ...
    for index, claim in enumerate(claims, start=1):
        ...
        lines.extend(
            [
                ...
                f"- **Core user action:** {_clean(claim.get('core_user_action'))}",
                f"- **Irreducible side effect:** {_clean(claim.get('irreducible_side_effect'))}",
                f"- **Cost / authorization:** {_clean(claim.get('cost_authorization'))}",
