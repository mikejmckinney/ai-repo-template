...
- **Retain** durable surfaces for the same concerns outside the rule catalog:
  ...
  - Ownership / parallelism → [ADR-009](./adr-009-parallel-multi-agent-execution.md) tooling remains; live ownership table enforcement is **deferred** until a future benchmark or operational need justifies restoring `agent_ownership.md`
