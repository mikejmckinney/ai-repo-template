...
| [ADR-005](./adr-005-analyst-preflight-gate.md) | Analyst Pre-Flight gate | Superseded by ADR-014 |
...
| [ADR-014](./adr-014-extend-analyst-preflight-to-labeled-issues.md) | Extend Analyst Pre-Flight gate to label-triggered issues (supersedes ADR-005) | Accepted |
