...
| [ADR-003](./adr-003-claude-code-subagent-registration.md) | Claude Code subagent registration (two-registry design) | Superseded by ADR-032 |
| [ADR-004](./adr-004-analyst-role-and-feedback-loop.md) | Analyst role + feedback loop | Superseded by ADR-032 |
| [ADR-005](./adr-005-analyst-preflight-gate.md) | Analyst Pre-Flight gate | Superseded by ADR-032 |
...
| [ADR-008](./adr-008-phase4-default-and-copilot-fallback.md) | Phase 4 runs by default; Copilot-path relay-side fallback | Superseded by ADR-032 |
| [ADR-009](./adr-009-parallel-multi-agent-execution.md) | Parallel multi-agent execution (patterns, dispatch reality, conflict enforcement) | Superseded by ADR-032 |
...
| [ADR-014](./adr-014-extend-preflight-to-adhoc-deliverables.md) | Extend Analyst Pre-Flight gate to ad-hoc deliverable issues | Superseded by ADR-032 |
...
| [ADR-019](./adr-019-per-role-model-tiering.md) | Per-role model tiering across Claude Code and Copilot (Phase 2 of #220; supersedes ADR-003's `model: inherit` choice) | Superseded by ADR-032 |
...
| [ADR-023](./adr-023-shared-subagent-canonical.md) | Canonical role bodies in `.agents/<role>.md`; vendor folders carry thin overlays (supersedes ADR-003 in part) | Superseded by ADR-032 |
| [ADR-024](./adr-024-multi-model-consensus-planning.md) | Multi-model consensus planning — optional opt-in workflow shipped as prompt + guide; no new `synthesizer` role in v1 | Superseded by ADR-032 |
...
| [ADR-031](./adr-031-agent-model-roi-benchmark-policy.md) | Agent/model ROI benchmark procedure and current recommendations | Accepted |
| [ADR-032](./adr-032-monolithic-agent-and-review-lifecycle.md) | Monolithic agent and review lifecycle | Accepted |
