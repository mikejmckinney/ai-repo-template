...
| 3 | `feature/final-feedback-consolidation` | Merged (#382 @ `4b7408c`) — `agent-review-finalize.yml`, `scripts/workflows/pr-feedback/`, `.context/rules/README.md` read-profile catalog |
| 4 | `feature/postmerge-retro-review` | **Next** — `agent-postmerge-retro.yml`, `scripts/workflows/postmerge-retro/`, label `retro-review` |
