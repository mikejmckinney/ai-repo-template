...
| 4v2 | `feature/postmerge-retro-daily-v2` | **In PR #427** — nightly 06:00 UTC, umbrella issue/day, draft fix PR; cron + dispatch only; ADR-030; AGENTS.md v25; sandbox retro E2E green (#426). Read-profile automation smoke was removed (agents do not reliably load profile minimums from disk). |
