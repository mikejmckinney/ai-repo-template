...
- **Shared procedural prompts** (template-provided; e.g.) — [`op-issue-workflow.md`](op-issue-workflow.md) (OP issue→merge playbook),
  `pr-resolve-all.md`, `repo-onboarding.md`,
  `expand-backlog-entry.md`, `capture-postmortem.md`,
