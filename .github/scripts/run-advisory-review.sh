...
prompt_file="$WORKDIR/prompt.md"
{
  ...
  echo ""
  echo "### .context/rules/process_session_start.md"
  echo ""
  cat "$REPO_ROOT/.context/rules/process_session_start.md"
  echo ""
  echo "### .context/rules/README.md (rule catalog)"
  echo ""
  cat "$REPO_ROOT/.context/rules/README.md"
  echo ""
  echo "---"
  echo ""
