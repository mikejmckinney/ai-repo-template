...
[`docs/compliance_schemas.md`](../docs/compliance_schemas.md) and
...
and [ADR-031](../docs/decisions/adr-031-agent-model-roi-benchmark-policy.md) Amendment 2026-06-15. Read it before deciding to absorb
role-owned work.
...
AGENTS.md → `op-issue-workflow.md` path and need no parallel update.
...
- [`docs/guides/multi-agent-coordination.md`](../docs/guides/multi-agent-coordination.md) — path ownership, parallel work, and conflict-avoidance hierarchy.
- [`.github/prompts/op-issue-workflow.md`](prompts/op-issue-workflow.md) — Parent Orchestrator workflow when coordinating multi-role work.
