...
non-conventional / inconsistent with the rest of the doc tree.
If you spot a comment using this header on an issue or PR, treat
it as intentional infrastructure, not prose drift.
